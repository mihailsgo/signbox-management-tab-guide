...
- `images/management/annotated/03-management-overview-annotated.png`
- `images/management/annotated/04-document-profiles-list-annotated.png`
- `images/management/annotated/05-document-profiles-detail-annotated.png`
- `images/management/annotated/06-document-profiles-edit-annotated.png`
- `images/management/annotated/07-document-profiles-create-form-annotated.png`
- `images/management/annotated/08-document-attributes-list-annotated.png`
- `images/management/annotated/09-document-attributes-create-form-annotated.png`
